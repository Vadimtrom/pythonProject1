...
# преобразуем из множества в список
students1 = list(students)
# сортируем имена по алфавиту
students11 = sorted(students1)
# преобразуем в словарь при помощи команды dict и склеиваем
# при помощи команды zip
otvet = dict(zip(students11, grades))
print(otvet)